...
public class Exceptional {
    ...
    private static final class NumberIsNotNumberException extends Throwable {
    ...
    private static float calcMatrix(String[][] matrix) throws NumberIsNotNumberException {
        int result = 0;
